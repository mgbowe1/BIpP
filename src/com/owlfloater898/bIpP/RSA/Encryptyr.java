...
public class Encryptyr {
	
	public static void Encryptyr(String[] args) throws NoSuchAlgorithmException, NoSuchPaddingException, Exception
	{
		new Encryptyr().encryptMessage(args[1]);
	}
